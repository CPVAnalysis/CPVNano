...
float getTriggerScaleFactor(TString filename_sf, float pt, float eta){
  ...
  //TString filename_sf = "/t3home/anlyon/BHNL/BHNLNano/CMSSW_10_2_15/src/PhysicsTools/CPVNano/data/trigger_scale_factors/scaleFactor_results_cat_pt_eta_fit_A1.root";
