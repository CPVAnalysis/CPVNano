...
public :
   ...
   TTreeReaderArray<Float_t> BsToPhiPhiTo4K_Bs_lx_posz = {fReader, "BsToPhiPhiTo4K_Bs_lx_posz"};
   TTreeReaderArray<Float_t> BsToPhiPhiTo4K_Bs_ly_posz = {fReader, "BsToPhiPhiTo4K_Bs_ly_posz"};
   TTreeReaderArray<Float_t> BsToPhiPhiTo4K_Bs_lx_pvpos = {fReader, "BsToPhiPhiTo4K_Bs_lx_pvpos"};
   TTreeReaderArray<Float_t> BsToPhiPhiTo4K_Bs_ly_pvpos = {fReader, "BsToPhiPhiTo4K_Bs_ly_pvpos"};
   TTreeReaderArray<Float_t> BsToPhiPhiTo4K_Bs_ct_2D_cm = {fReader, "BsToPhiPhiTo4K_Bs_ct_2D_cm"};
   TTreeReaderArray<Float_t> BsToPhiPhiTo4K_Bs_ct_2D_cm_posz = {fReader, "BsToPhiPhiTo4K_Bs_ct_2D_cm_posz"};
   TTreeReaderArray<Float_t> BsToPhiPhiTo4K_Bs_ct_2D_cm_pvpos = {fReader, "BsToPhiPhiTo4K_Bs_ct_2D_cm_pvpos"};
   ...
   Float_t the_bs_lx_posz = -99.;
   Float_t the_bs_ly_posz = -99.;
   Float_t the_bs_lx_pvpos = -99.;
   Float_t the_bs_ly_pvpos = -99.;
   Float_t the_bs_ct_2d_cm = -99.;
   Float_t the_bs_ct_2d_cm_posz = -99.;
   Float_t the_bs_ct_2d_cm_pvpos = -99.;
