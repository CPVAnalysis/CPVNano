...
muonBParkTable = cms.EDProducer("SimplePATMuonFlatTableProducer",
    ...
    variables = cms.PSet(
		...
		pfiso03_sumChargedHadronPt = Var("pfIsolationR03().sumChargedHadronPt", float, doc="PF isolation dR=0.3"),
		pfiso03_sumChargedParticlePt = Var("pfIsolationR03().sumChargedParticlePt", float, doc="PF isolation dR=0.3"),
		pfiso03_sumNeutralHadronEt = Var("pfIsolationR03().sumNeutralHadronEt", float, doc="PF isolation dR=0.3"),
		pfiso03_sumPhotonEt = Var("pfIsolationR03().sumPhotonEt", float, doc="PF isolation dR=0.3"),
		pfiso03_sumNeutralHadronEtHighThreshold = Var("pfIsolationR03().sumNeutralHadronEtHighThreshold", float, doc="PF isolation dR=0.3"),
		pfiso03_sumPhotonEtHighThreshold = Var("pfIsolationR03().sumPhotonEtHighThreshold", float, doc="PF isolation dR=0.3"),
		pfiso03_sumPUPt = Var("pfIsolationR03().sumPUPt", float, doc="PF isolation dR=0.3"),
		...
		pfiso04_sumChargedHadronPt = Var("pfIsolationR04().sumChargedHadronPt", float, doc="PF isolation dR=0.4"),
		pfiso04_sumChargedParticlePt = Var("pfIsolationR04().sumChargedParticlePt", float, doc="PF isolation dR=0.4"),
		pfiso04_sumNeutralHadronEt = Var("pfIsolationR04().sumNeutralHadronEt", float, doc="PF isolation dR=0.4"),
		pfiso04_sumPhotonEt = Var("pfIsolationR04().sumPhotonEt", float, doc="PF isolation dR=0.4"),
		pfiso04_sumNeutralHadronEtHighThreshold = Var("pfIsolationR04().sumNeutralHadronEtHighThreshold", float, doc="PF isolation dR=0.4"),
		pfiso04_sumPhotonEtHighThreshold = Var("pfIsolationR04().sumPhotonEtHighThreshold", float, doc="PF isolation dR=0.4"),
		pfiso04_sumPUPt = Var("pfIsolationR04().sumPUPt", float, doc="PF isolation dR=0.4"),
