...
public :
   ...
   TTreeReaderArray<Float_t> PhiToKK_phi_eta = {fReader, "PhiToKK_phi_eta"};
   ...
   TTreeReaderArray<Float_t> PhiToKK_phi_k1_pt = {fReader, "PhiToKK_phi_k1_pt"};
   ...
   TTreeReaderArray<Float_t> PhiToKK_phi_k2_pt = {fReader, "PhiToKK_phi_k2_pt"};
   ...
   TTreeReaderArray<Float_t> PhiToKK_phi_mass = {fReader, "PhiToKK_phi_mass"};
   TTreeReaderArray<Float_t> PhiToKK_phi_masserr = {fReader, "PhiToKK_phi_masserr"};
   TTreeReaderArray<Float_t> PhiToKK_phi_phi = {fReader, "PhiToKK_phi_phi"};
   TTreeReaderArray<Float_t> PhiToKK_phi_pt = {fReader, "PhiToKK_phi_pt"};
   TTreeReaderArray<Float_t> PhiToKK_phi_sv_chi2 = {fReader, "PhiToKK_phi_sv_chi2"};
   TTreeReaderArray<Float_t> PhiToKK_phi_sv_ndof = {fReader, "PhiToKK_phi_sv_ndof"};
   TTreeReaderArray<Float_t> PhiToKK_phi_sv_prob = {fReader, "PhiToKK_phi_sv_prob"};
