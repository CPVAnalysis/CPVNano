...
if __name__ == "__main__":
  ...
  domini = True
  suffix='' if not domini else '_mini'
  ...
  path_1 = 'bhnl_recoeff_V20_test{}.root'.format(suffix,suffix)
  #path_2 = 'bhnl_recoeff_dg{}.root'.format(suffix,suffix)
  path_3 = 'bhnl_recoeff_V20_test_dsa{}.root'.format(suffix,suffix)
  #path_4 = 'LxyCompTwoDir_imrovedMatchEff_v2{}/bhnl_recoeff_displAll{}.root'.format(suffix,suffix)
  ...
  eff1.SetTitle('slimmed muons;gen L_{xy} (cm);Vtx reconstruction efficiency')
  ...
  eff3.SetTitle('slimmed + DSA muons;gen L_{xy} (cm);Vtx reconstruction efficiency')
  ...
  c.SetGridy()
  c.SaveAs('recoeff_comparison_Lxy.png')
  ...
  c.SaveAs('recoeff_comparison_pT.png')
  ...
  #eff2.GetXaxis().SetTitle('L_{xy} (cm)')
  #eff2.GetYaxis().SetTitle('Vtx reconstruction efficiency')
  c.SaveAs('recoeff_comparison_2D.png')
  ...
  c2.SaveAs('recoeff_comparison_2D_dgdsa.png')
