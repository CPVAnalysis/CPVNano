...
void BsToPhiPhiTo4KDumper::SlaveBegin(TTree * /*tree*/)
{
   ...
   signal_tree->Branch("bs_lx_posz", &the_bs_lx_posz);
   signal_tree->Branch("bs_ly_posz", &the_bs_ly_posz);
   signal_tree->Branch("bs_lx_pvpos", &the_bs_lx_pvpos);
   signal_tree->Branch("bs_ly_pvpos", &the_bs_ly_pvpos);
   signal_tree->Branch("bs_ct_2d_cm", &the_bs_ct_2d_cm);
   signal_tree->Branch("bs_ct_2d_cm_posz", &the_bs_ct_2d_cm_posz);
   signal_tree->Branch("bs_ct_2d_cm_pvpos", &the_bs_ct_2d_cm_pvpos);
...
Bool_t BsToPhiPhiTo4KDumper::Process(Long64_t entry)
{
   ...
   if(nCand_sig > 0){ // at least one candidate per event
      ...
      the_bs_ct_2d_cm_posz = BsToPhiPhiTo4K_Bs_ct_2D_cm_posz[cand_idx];
      the_bs_ct_2d_cm_pvpos = BsToPhiPhiTo4K_Bs_ct_2D_cm_pvpos[cand_idx];
      ...
      the_bs_lx_posz = BsToPhiPhiTo4K_Bs_lx_posz[cand_idx];
      the_bs_ly_posz = BsToPhiPhiTo4K_Bs_ly_posz[cand_idx];
      the_bs_lx_pvpos = BsToPhiPhiTo4K_Bs_lx_pvpos[cand_idx];
      the_bs_ly_pvpos = BsToPhiPhiTo4K_Bs_ly_pvpos[cand_idx];
