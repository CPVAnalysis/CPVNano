...
class NanoMerger(NanoTools):
  ...
  def doMerging(self, nanoName, mergedName, locationSE, outputdir, cond):
    ...
    for idir, subdir in enumerate(subdirs):
      ...
      print 
      #if 'Chunk0_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      ##if 'Chunk1_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk2_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk3_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk4_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk5_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk6_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk7_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk8_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
      #if 'Chunk9_' in subdir[subdir.rfind('/')+1:len(subdir)]: continue
  ...
  def process(self):
    ...
    if self.mcprivate:
      locationSE = '/pnfs/psi.ch/cms/trivcat/store/user/{}/CPVGen/{}/'.format(user, self.prodlabel)
      ...
      locationSE = '/pnfs/psi.ch/cms/trivcat/store/user/{}/CPVGen/{}/{}/{}'.format(user, 'data' if self.data else ('mc_central' if self.mccentral else 'signal_central'), self.prodlabel, dataset_label)
