...
BsToPhiPhiTo4KTable = cms.EDProducer(
    ...
    variables=cms.PSet(
        ...
        Bs_px = ufloat('Bs_fitted_px'),
        Bs_py = ufloat('Bs_fitted_py'),
        Bs_ptErr = ufloat('Bs_fitted_ptErr'),
        ...
        Bs_lxyErr = ufloat('Bs_lxyErr'),
        Bs_lxy_sig = ufloat('Bs_lxy_sig'),
        Bs_lxy_corr = ufloat('Bs_lxy_corr'),
        Bs_lxyErr_corr = ufloat('Bs_lxyErr_corr'),
        Bs_lxy_sig_corr = ufloat('Bs_lxy_sig_corr'),
        Bs_lxyz = ufloat('Bs_lxyz'),
        Bs_lxyzErr = ufloat('Bs_lxyzErr'),
        Bs_lxyz_corr = ufloat('Bs_lxyz_corr'),
        Bs_lxyzErr_corr = ufloat('Bs_lxyzErr_corr'),
        Bs_lx = ufloat('Bs_lx'),
        Bs_ly = ufloat('Bs_ly'),
        Bs_lx_posbsz = ufloat('Bs_lx_posbsz'),
        Bs_ly_posbsz = ufloat('Bs_ly_posbsz'),
        Bs_lx_posbspv = ufloat('Bs_lx_posbspv'),
        Bs_ly_posbspv = ufloat('Bs_ly_posbspv'),
        Bs_lx_posthepv = ufloat('Bs_lx_posthepv'),
        Bs_ly_posthepv = ufloat('Bs_ly_posthepv'),
        Bs_ct_2D_cm = ufloat('Bs_ct_2D_cm'),
        ...
        the_PV_covXX = ufloat('the_PV_covXX'),
        the_PV_covYY = ufloat('the_PV_covYY'),
        the_PV_covZZ = ufloat('the_PV_covZZ'),
        the_PV_covXY = ufloat('the_PV_covXY'),
        the_PV_covXZ = ufloat('the_PV_covXZ'),
        the_PV_covYZ = ufloat('the_PV_covYZ'),
        the_PV_x = ufloat('the_PV_x'),
        the_PV_y = ufloat('the_PV_y'),
        the_PV_z = ufloat('the_PV_z'),
