...
BsToPhiPhiTo4KTable = cms.EDProducer(
    ...
    variables=cms.PSet(
        ...
        Bs_lx = ufloat('Bs_lx'),
        Bs_ly = ufloat('Bs_ly'),
        Bs_lx_posz = ufloat('Bs_lx_posz'),
        Bs_ly_posz = ufloat('Bs_ly_posz'),
        Bs_lx_pvpos = ufloat('Bs_lx_pvpos'),
        Bs_ly_pvpos = ufloat('Bs_ly_pvpos'),
        Bs_ct_2D_cm = ufloat('Bs_ct_2D_cm'),
        Bs_ct_2D_cm_posz = ufloat('Bs_ct_2D_cm_posz'),
        Bs_ct_2D_cm_pvpos = ufloat('Bs_ct_2D_cm_pvpos'),
