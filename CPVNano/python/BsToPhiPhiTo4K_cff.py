...
BsToPhiPhiTo4K = cms.EDProducer(
    ...
    kaonsTransientTracks = cms.InputTag('tracksBPark', 'SelectedTransientTracks'),
    muons = cms.InputTag('muonTrgSelector', 'trgMuons'), 
...
BsToPhiPhiTo4KTable = cms.EDProducer(
    ...
    variables=cms.PSet(
        ...
        k1_dxy = ufloat('k1_dxy'),
        k1_dxyS = ufloat('k1_dxyS'),
        k1_dz = ufloat('k1_dz'),
        k1_dzS = ufloat('k1_dzS'),
        k1_dcasig_pv = ufloat('k1_dcasig_pv'),

        k2_mass = ufloat('k2_fitted_mass'),
        k2_pt = ufloat('k2_fitted_pt'),
        k2_eta = ufloat('k2_fitted_eta'),
        k2_phi = ufloat('k2_fitted_phi'),
        k2_dxy = ufloat('k2_dxy'),
        k2_dxyS = ufloat('k2_dxyS'),
        k2_dz = ufloat('k2_dz'),
        k2_dzS = ufloat('k2_dzS'),
        k2_dcasig_pv = ufloat('k2_dcasig_pv'),

        k3_mass = ufloat('k3_fitted_mass'),
        k3_pt = ufloat('k3_fitted_pt'),
        k3_eta = ufloat('k3_fitted_eta'),
        k3_phi = ufloat('k3_fitted_phi'),
        k3_dxy = ufloat('k3_dxy'),
        k3_dxyS = ufloat('k3_dxyS'),
        k3_dz = ufloat('k3_dz'),
        k3_dzS = ufloat('k3_dzS'),
        k3_dcasig_pv = ufloat('k3_dcasig_pv'),

        k4_mass = ufloat('k4_fitted_mass'),
        k4_pt = ufloat('k4_fitted_pt'),
        k4_eta = ufloat('k4_fitted_eta'),
        k4_phi = ufloat('k4_fitted_phi'),
        k4_dxy = ufloat('k4_dxy'),
        k4_dxyS = ufloat('k4_dxyS'),
        k4_dz = ufloat('k4_dz'),
        k4_dzS = ufloat('k4_dzS'),
        k4_dcasig_pv = ufloat('k4_dcasig_pv'),

        trgmu_dxy = ufloat('trgmu_dxy'),
        trgmu_dxyS = ufloat('trgmu_dxyS'),
        trgmu_dz = ufloat('trgmu_dz'),
        trgmu_dzS = ufloat('trgmu_dzS'),
